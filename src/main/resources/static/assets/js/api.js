(function () {
    ...
    const USER_ID_KEY = "investment.userId";
    ...
    const api = {
        ...
        listPersonalProducts: () => request("/products/personal"),
        createPersonalProduct: (payload) => request("/products/personal", { method: "POST", body: payload }),
        updatePersonalProduct: (productId, payload) => request(`/products/personal/${encodeURIComponent(productId)}`, { method: "PUT", body: payload }),
        deletePersonalProduct: (productId) => request(`/products/personal/${encodeURIComponent(productId)}`, { method: "DELETE" }),
        listPublicProducts: () => request("/products/public"),
