package com.investment.agent.factory;

import com.investment.agent.builder.*;
...
public class AgentFactory {
    ...
    public AgentFactory(
            ...
            @Value("${investment.prompt.version:v1}") String promptVersion
    ) {
