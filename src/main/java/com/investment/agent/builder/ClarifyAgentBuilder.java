...
public class ClarifyAgentBuilder {
    ...
    public ClarifyAgentBuilder(@Qualifier("InvestmentLightChatModel") Model lightModel, PromptLoader promptLoader) {
    ...
    public ReActAgent build() {
        return ReActAgent.builder()
                .name("investment_clarify_agent")
                .model(lightModel)
                .sysPrompt(promptLoader.load("investment/prompts/clarify.txt"))
