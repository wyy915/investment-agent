...
public class IntentAgentBuilder {
    ...
    public IntentAgentBuilder(@Qualifier("InvestmentLightChatModel") Model lightModel, PromptLoader promptLoader) {
    ...
    public ReActAgent build() {
        return ReActAgent.builder()
                .name("investment_intent_agent")
                .model(lightModel)
                .sysPrompt(promptLoader.load("investment/prompts/intent.txt"))
