...
public class ChatResponse {
    ...
    private List<ProductResponse> displayBlocks;
    private String nextAction;
    private String clarifyQuestion;
    private List<String> missingSlots;

    public static ChatResponse answer(String sessionId, String speechText, List<ProductResponse> displayBlocks, String nextAction) {
        return answer(sessionId, null, speechText, displayBlocks, nextAction);
    }

    public static ChatResponse answer(String sessionId, String traceId, String speechText, List<ProductResponse> displayBlocks, String nextAction) {
